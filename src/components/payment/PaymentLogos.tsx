...
export function BKashIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* bKash Origami Bird Vector */}
      <path
        d="M22 68L48 24L74 48L44 48L22 68Z"
        fill="#FFFFFF"
      />
      <path
        d="M48 24L78 32L62 52L48 24Z"
        fill="#FFFFFF"
        fillOpacity="0.85"
      />
      <path
        d="M44 48L74 48L58 72L44 48Z"
        fill="#FFFFFF"
        fillOpacity="0.9"
      />
      <path
        d="M22 68L44 48L36 78L22 68Z"
        fill="#FFFFFF"
        fillOpacity="0.75"
      />
    </svg>
...
export function RocketIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M32 58L22 68L35 66L32 58Z"
        fill="#FFC107"
      />
      <path
        d="M68 58L78 68L65 66L68 58Z"
        fill="#FFC107"
      />
      <path
        d="M50 75L45 85L50 82L55 85L50 75Z"
        fill="#FF5722"
      />
    </svg>
  );
